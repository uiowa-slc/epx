<div class="header__container header__container--{$DarkLightHeader} header__container--{$HeaderType}">
	...
	<header id="header" class="header header--{$DarkLightHeader} header--{$HeaderType}" role="banner">
		...
		<div itemscope="" class="hide-for-medium" itemtype="http://schema.org/Organization">
			<h1 class="header__site-title"><a href="$AbsoluteBaseURL" class="header__link--{$DarkLightHeader}" itemprop="url"><span class="show-for-sr" itemprop="name">$SiteConfig.Title</span><img src="{$ThemeDir}/src/images/epx-logo-youtube-tiU4AYPdIOw.png" width="240" class="nav__logo" alt="" role="presentation" /></a></h1>
		</div>
